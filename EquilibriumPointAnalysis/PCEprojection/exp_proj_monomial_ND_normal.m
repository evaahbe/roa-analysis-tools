function mono = exp_proj_monomial_ND_hermite(var, vari, fix_var, fix_vari,  monobase, I, obj, norm_dec)
    ...
    if norm_dec == 1
        basis_tensor = create_tensor_reshaped_Hermite((I-1),obj.p,dim);
    elseif norm_dec == 0
        basis_tensor = create_tensor_reshaped_Hermite_nonorm((I-1),obj.p,dim);
    else
