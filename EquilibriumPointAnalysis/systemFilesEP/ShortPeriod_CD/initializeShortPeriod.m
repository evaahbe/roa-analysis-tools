function [sys,fns] = initializeShortPeriod(sys,fns)
    ...
    sys.mu{1}.mu_A = 0; % lower distribution limit
    sys.mu{1}.mu_B = 2; % upper distribution bound
...
%     sys.mu{1}.mu_coefs = galerkin_projection_normal(sys.mu{1}.mu_A,sys.mu{1}.mu_B,sys.p); 
    ...
    fns.system_dyn= str2func('dynamics_ShortPeriod');
    fns.system_dyn_int= str2func('dynamics_ShortPeriod_INT');
    fns.system_dyn_poly = str2func('dynamics_ShortPeriod'); 
